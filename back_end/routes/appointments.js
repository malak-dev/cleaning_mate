...
module.exports = db => {
  ...
  router.put("/book/:providerId", (req, res) => {
    ...
    const { selected_startTime, selected_hours, selectedDate, clientId } = req.body;
    ...
    let query = {
      ...
      values: [Number(selected_startTime), Number(selected_hours), selectedDate, providerId, clientId]
    };
    db.query(query).then(
